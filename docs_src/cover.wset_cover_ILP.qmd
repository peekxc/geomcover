# cover.wset_cover_ILP { #geomcover.cover.wset_cover_ILP }
...
|-----------|------------|-----------------------------------------------------------------------------|------------|
| `subsets` | csc_matrix | (n x J) sparse matrix of J subsets whose union forms a cover over n points. | _required_ |
